...
const MainPostItemMobileLoading = () => {
  return (
    <>
      <div className="mx-auto flex w-full h-full flex-col items-center justify-center space-y-8">
        <div
          role="status"
          className="w-full h-full mx-auto max-w-md animate-pulse rounded border border-gray-200 p-4 shadow dark:border-gray-700 md:p-6"
        >
